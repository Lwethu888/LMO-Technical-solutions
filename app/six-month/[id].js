    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.description}>
          Detailed information about the course <Text style={styles.courseId}>{id}</Text>.  
          Here you can add description, syllabus, duration, fees, and other relevant details.
        </Text>
